...
df = pd.read_csv('Model_LCS_acc.csv')
...
ax.set_ylabel('LCS acc', fontsize=24)
...
plt.savefig("./LCS acc V2.svg", bbox_inches='tight')
plt.savefig("./fig16(c).jpg", bbox_inches='tight')
plt.show()