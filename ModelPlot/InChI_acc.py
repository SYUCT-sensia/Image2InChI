...
df = pd.read_csv('Model_InChI_acc.csv')
...
ax.set_ylabel('InChI acc', fontsize=24)
...
plt.savefig("./InChI acc V2.svg", bbox_inches='tight')
plt.savefig("./fig16(a).jpg", bbox_inches='tight')
plt.show()